        ...
        <DashboardLayout>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Create New Team</h1>
                        <p className="mt-2 text-slate-500 text-sm">Initialize a new team for the current season.</p>
                    </div>
                    <Link
