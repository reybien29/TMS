...
export default function Index({ auth, players, filters }) {
    return (
        <DashboardLayout>
            <Head title="Players Roster" />

            <div className="max-w-[1200px]">
                {/* Header Section */}
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <h1 className="text-4xl font-black text-gray-900 tracking-tight">Players</h1>
                        <p className="text-slate-500 mt-2 font-medium">
                            Manage the athlete roster and team assignments.
                        </p>
                    </div>
                    <Link 
                        ...
                        <table className="min-w-full divide-y divide-slate-100">
                            <thead>
                                <tr className="bg-slate-50/50">
                                    <th className="px-8 py-5 text-left text-[10px] font-black uppercase tracking-widest text-slate-400">Player</th>
                                    <th className="px-8 py-5 text-left text-[10px] font-black uppercase tracking-widest text-slate-400">Position</th>
                                    <th className="px-8 py-5 text-left text-[10px] font-black uppercase tracking-widest text-slate-400">Team</th>
                                    <th className="px-8 py-5 text-left text-[10px] font-black uppercase tracking-widest text-slate-400">Jersey #</th>
                                    ...
                                    <tr>
                                        <td colSpan="5" className="px-8 py-20 text-center">
                                            <div className="flex flex-col items-center opacity-40">
                                                ...
                                                <p className="font-bold text-slate-400">No players found in the roster.</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
