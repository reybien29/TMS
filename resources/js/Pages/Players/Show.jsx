...
export default function Show({ player }) {
    ...
    return (
        <DashboardLayout>
            <Head title={`Player Profile: ${player.first_name}`} />

            <div className="max-w-4xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Player Profile</h1>
                        <p className="mt-2 text-slate-500 text-sm">Detailed information for {player.first_name} {player.last_name}.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-1">
                        <div className="bg-[#0a0f1c] rounded-2xl shadow-2xl border border-slate-800/50 p-8 flex flex-col items-center text-center text-white">
                            ...
                            <h2 className="text-2xl font-black text-white mb-2">{player.first_name} {player.last_name}</h2>
                            ...
                            <div className="w-full pt-8 border-t border-slate-700 flex flex-col items-center gap-4">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-base font-bold text-white">{player.team?.name || 'Unassigned'}</p>
                                </div>
                                <div>
