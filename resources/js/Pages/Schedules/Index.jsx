                    ...
                    <div className="xl:col-span-4 sticky top-8 space-y-8">
                        <div className="bg-[#0f172a] rounded-[40px] p-10 text-white shadow-2xl shadow-blue-900/20 relative overflow-hidden group">
                            ...
                            <div className="flex items-center justify-between mb-10 relative">
                                <button onClick={() => setCurrentDate(new Date(currentDate.setMonth(currentDate.getMonth() - 1)))} className="p-3 hover:bg-white/10 rounded-2xl transition-all border border-white/5">
                                    ...
                                    <div key={game.id} className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-slate-200/50 group relative overflow-hidden">
                                        <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                                            ...
                                            <div className="flex-1 grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] items-center gap-8 w-full">
                                                <div className="text-right space-y-1">
                                                    ...
                                                    <h3 className="text-xl md:text-2xl font-black text-slate-900 capitalize group-hover:text-blue-600 transition-colors leading-tight">{game.home_team?.name?.toLowerCase() || 'tbd'}</h3>
                                                </div>
                                                ...
                                                <div className="text-left space-y-1">
                                                    ...
                                                    <h3 className="text-xl md:text-2xl font-black text-slate-900 capitalize group-hover:text-blue-600 transition-colors leading-tight">{game.away_team?.name?.toLowerCase() || 'tbd'}</h3>
                                                </div>
                                            </div>
                                        ...
                                        <div className="mt-8 pt-6 border-t border-slate-50 flex flex-wrap gap-6 items-center">
                                            <div className="flex items-center gap-2 text-slate-400">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest">{game.location?.toLowerCase()}</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-slate-400">
