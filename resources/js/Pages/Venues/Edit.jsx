...
export default function Edit({ venue }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('venues.update', venue.id));
    };
        ...
        <DashboardLayout>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Edit Venue</h1>
                        <p className="mt-2 text-slate-500 text-sm">Update settings for {venue.name}.</p>
                    </div>
                    <Link
